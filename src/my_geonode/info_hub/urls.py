...
urlpatterns = [
    ...
    path('wms-layers', api.wms_layers_api_view, name='wms-layers-api-compat'),
    ...
    # Compatibility alias (when mounted under /api/info_hub/)
    path('layer-attributes', api.layer_attributes_api_view, name='layer-attributes-api-compat'),
